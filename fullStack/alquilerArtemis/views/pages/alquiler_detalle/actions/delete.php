...
if (isset($_POST['Eliminar'])) {
    $url = "http://localhost/ArTeM01-043/alqulartemis/fullStack/apiRest/controllers/Alquiler_Detalle.php?op=Delete";
    $data = array(
        'Alquiler_Detalle_ID' => $_POST['Alquiler_Detalle_ID']
    );
    ...
    echo "<script>alert('Cliente eliminado');document.location='alquiler_detalle'</script>";
}
?>